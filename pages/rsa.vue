<template>
    <div class="prose">
        <HeadingWithHomeButton title="rsa calculator" />
        <h2>generate keys</h2>
        ...
        <div class="flex gap-4">
            <div class="flex flex-col gap-2">
                ...
                <span class="bg-warning p-2 text-warning-content rounded-lg" v-if="!isPrime(p)">{{ p }} is not
                    prime</span>
            </div>
            <div class="flex flex-col gap-2">
                ...
                <span class="bg-warning p-2 text-warning-content rounded-lg" v-if="!isPrime(q)">{{ q }} is not
                    prime</span>
            </div>
        </div>
